...
- Name: dom-testing\login.spec.ts >> Login Page >> should have submit button with proper styling
- Location: dom-testing\login.spec.ts:121:3
...
Call log:
  ...
  - waiting for locator('button[type="submit"]')
    13 × locator resolved to <button type="submit">Sign In</button>
